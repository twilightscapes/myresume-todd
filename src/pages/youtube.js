...
<div className='player-wrapper' style={{position:'relative', width:'100vw',  top:'', border:'0px solid blue', zIndex:'0', height:'content-fill', overflow:'hidden' }}>
...
<div className="" style={{display:'block', justifyContent:'center', width:'100%', margin:'0 auto', flexDirection:'row', maxWidth:'1000px', border:'0px solid red', position:'relative', top:'-120px', height:''}}>
